      ...
      <div className="text-center space-y-6">
        ...
        <div>
          ...
          <p className="body-text text-muted-foreground">
            Your makeup session has been successfully booked. You'll receive a
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                <p className="font-semibold">
                  {bookingData.clientDetails?.firstName}{" "}
                  {bookingData.clientDetails?.lastName}
                </p>
                <p className="text-muted-foreground">
        ...
        <div>
          ...
          <div className="flex justify-between mt-6">
            ...
            >
              {isProcessing
                ? "Processing..."
                : `Confirm & Pay $${(total * 0.5).toFixed(2)}`}
            </Button>
          </div>
        </div>
      </div>
